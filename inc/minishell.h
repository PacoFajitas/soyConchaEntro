...
/*   Updated: 2024/03/18 16:21:11 by tfiguero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*ft_reline(t_token **token);
/*	expansor.c	*/
t_token		*ft_expan(t_token **token, t_data *data, int type, int *exp);
char		*ft_expan_if(t_data *data, t_token *tmp, int *exp, char *content);
...
/*	echo.c	*/
int			ft_echo(t_pipe *pipe);
/*	exit.c	*/
int			ft_exit(t_data *data);
int			ft_exit_b(t_pipe *p, t_data *data);
int			ft_check_error(t_pipe *p);
/*	pwd.c	*/
